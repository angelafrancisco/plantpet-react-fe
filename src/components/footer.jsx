            ...
            <div className="footer-wrapper">
                <div className="footer-container top">
                    ...
                    <ul className="footer-links-list social">
                        ...
                        <li>
                            <a href="https://github.com/angelafrancisco/plant-front-end" className="footer-link github"><i className="fa-brands fa-github-square fa-2xl"></i></a>
                        </li>
                    </ul>
                </div>
                <div className="footer-container bottom">
                    <Link to="/" className="footer-logo"><img src="favicon.ico" alt="PlantPet Logo" />PlantPet</Link>
